...
public class FileUtil {
	...
	public static void mkpdir(File desFile){
	 ...
	 * @throws IOException
	 */
	public static void copyFile(String srcFile,String dirDest,String destFileName) {
		
		try {
			
			FileInputStream in = new FileInputStream(srcFile);
			mkdir(dirDest);
			FileOutputStream out = new FileOutputStream(dirDest+File.separator+destFileName);
